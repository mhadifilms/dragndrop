...
final class ExtractionTests: XCTestCase {
    ...
    func testPathTemplateBuildPath() {
        ...
        XCTAssertEqual(result, "CLIENTS/Acme/SHOWS/MyShow/shots/0010/vfx/")
    }
    ...
    func testExtractionRuleBasicMatch() {
        ...
        let result = rule.extract(from: "MyShow_102_0010_comp.nk")

        XCTAssertNotNil(result)
        XCTAssertEqual(result?["show"], "MyShow")
    ...
    func testExtractionRuleDisabled() {
        ...
        let result = rule.extract(from: "MyShow_102")
        XCTAssertNil(result)
    }
    ...
    func testExtractionRuleWithTransformations() {
        ...
        XCTAssertNotNil(result)
        XCTAssertEqual(result?["show_upper"], "MYSHOW")
        XCTAssertEqual(result?["show_lower"], "myshow")
    }
