...
final class IntegrationTests: XCTestCase {
    ...
    func testWorkflowExtractionPipeline() throws {
        ...
        if let values = extractedValues {
            ...
            XCTAssertEqual(path, "projects/Berlin/102/shots/0010/vfx/")
        }
    }
    ...
    func testMultipleExtractionRulesPriority() {
        ...
        let filename = "Berlin_102_test.nk"
        ...
        XCTAssertEqual(genericResult?["NAME"], "Berlin")

        XCTAssertNotNil(specificResult)
        XCTAssertEqual(specificResult?["SHOW"], "Berlin")
    ...
    func testUploadHistoryItemConversion() {
        var job = UploadJob(
            sourceURL: URL(fileURLWithPath: "/Users/test/Berlin_102_0010_comp.nk"),
            destinationPath: "projects/Berlin/102/shots/0010/vfx/Berlin_102_0010_comp.nk",
            bucket: "vfx-bucket",
            region: "us-east-1",
            fileInfo: FileInfo(
                filename: "Berlin_102_0010_comp.nk",
                fileExtension: "nk",
                size: 5 * 1024 * 1024,
                category: .nukeComp
            )
        ...
        XCTAssertEqual(historyItem.filename, "Berlin_102_0010_comp.nk")
        ...
        XCTAssertEqual(historyItem.s3URI, "s3://vfx-bucket/projects/Berlin/102/shots/0010/vfx/Berlin_102_0010_comp.nk")
    }
