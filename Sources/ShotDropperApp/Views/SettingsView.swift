...
struct AdvancedSettingsView: View {
    ...
    var body: some View {
        Form {
            ...
            Section("Finder Integration") {
                ...
                Text("URL Scheme: shotdropper://upload?file=/path/to/file")
                    .font(.caption)
                    .foregroundStyle(.secondary)
    ...
    private func openLogFile() {
        let logPath = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask).first!
            .appendingPathComponent("ShotDropper/logs")
    ...
    private func installFinderQuickAction() {
        ...
        panel.nameFieldStringValue = "Upload with ShotDropper.workflow"
