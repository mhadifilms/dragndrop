...
public struct PathTemplate: Codable, Equatable, Sendable {
    ...
    /// Static prefix path (e.g., "CLIENTS/Sync_Reed/03_Berlin/")
...
extension WorkflowConfiguration {
    ...
    public static var sampleVFXWorkflow: WorkflowConfiguration {
        WorkflowConfiguration(
            ...
            region: "us-east-1",
            pathTemplate: PathTemplate(
                template: "CLIENTS/Sync_Reed/03_Berlin/{SHOW}_S02/{EPISODE}20_WORKING/{show}_{episode}_{shot}_{category}/03_VFX/",
                placeholders: [
                ...
                staticPrefix: "CLIENTS/Sync_Reed/03_Berlin/",
                staticSuffix: "/03_VFX/"
            ),
            extractionRules: [
                ExtractionRule(
